...
const TELEMETRY_ATTRIBUTE_ALLOWLIST: &[&str] = &[
    ...
    "llama_stage.verify_window.credit_checks",
    ...
    "llama_stage.verify_window.credit_grants",
    "llama_stage.verify_window.credit_limit",
    "llama_stage.verify_window.credit_lock_poisoned_denials",
    "llama_stage.verify_window.credit_pipeline_occupied_denials",
    "llama_stage.verify_window.credit_queue_max",
